            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?= base_url('carreras/create') ?>" class="btn btn-success btn-sm">
                ...
                <div class="card-body">
                    <table id="registros" class="table table-bordered table-hover" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><code><?= esc($carrera->codigo_carrera) ?></code></td>
                                <td><?= esc($carrera->nombre_carrera) ?></td>
                                <td>
                                    <a href="<?= base_url('carreras/edit/' . $carrera->codigo_carrera) ?>" class="btn btn-warning btn-sm" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modalEliminar" data-url="<?= base_url('carreras/delete/' . $carrera->codigo_carrera) ?>" title="Eliminar">
