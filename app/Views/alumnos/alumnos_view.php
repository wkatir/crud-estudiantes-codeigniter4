...
<?= $this->section('content') ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Filtrar por Carrera</h3>
                </div>
                <div class="card-body">
                    <form method="post" action="<?= base_url('alumnosxcarrera/filtrar') ?>">
                        ...
                        <div class="input-group">
                            <select name="codigo_carrera" class="form-control" required>
                                ...
                                <option value="<?= esc($c->codigo_carrera) ?>">
    ...
    <?php elseif(isset($codigo_carrera_seleccionada)): ?>
    <div class="row">
        <div class="col-12">
            <div class="alert alert-info">
                <h5><i class="icon fas fa-info"></i> Informacion</h5>
                No se encontraron alumnos para la carrera seleccionada.
            </div>
        </div>
    </div>
    <?php endif; ?>
